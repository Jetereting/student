...
func (sc *StudentCreate) SetSort(u uint32) *StudentCreate {
	sc.mutation.SetSort(u)
	return sc
}

// SetNillableSort sets the "sort" field if the given value is not nil.
func (sc *StudentCreate) SetNillableSort(u *uint32) *StudentCreate {
	if u != nil {
		sc.SetSort(*u)
	}
	return sc
...
func (sc *StudentCreate) check() error {
	...
	if _, ok := sc.mutation.Sort(); !ok {
		return &ValidationError{Name: "sort", err: errors.New(`ent: missing required field "Student.sort"`)}
	}
	if _, ok := sc.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`ent: missing required field "Student.name"`)}
	}
	if _, ok := sc.mutation.IDCard(); !ok {
		return &ValidationError{Name: "id_card", err: errors.New(`ent: missing required field "Student.id_card"`)}
	}
	return nil
}
