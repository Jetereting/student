...
func (cq *ClassQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (cq *ClassQuery) FirstIDX(ctx context.Context) uint64 {
...
func (cq *ClassQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (cq *ClassQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (cq *ClassQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (cq *ClassQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (cq *ClassQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(class.Table, class.Columns, sqlgraph.NewFieldSpec(class.FieldID, field.TypeUint64))
	_spec.From = cq.sql
